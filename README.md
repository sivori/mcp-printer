...
| `MCP_PRINTER_MAX_RENDER_BYTES`         | `10000000`                                | Maximum file size (bytes) eligible for markdown/code rendering. Larger files error (or print as-is if fallback is enabled). Set to `0` for no limit               |
